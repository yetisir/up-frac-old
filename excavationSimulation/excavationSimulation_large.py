...
def sketchPart(name, gp):
    ...
    s.CircleByCenterPerimeter(center=(50.0, 50.0), point1=(50, 52))
...
def applyBoundaryCondition(instance):
    ...
    edges1 = a.instances[instance].edges.findAt(((50, 100, 0.0), ))
